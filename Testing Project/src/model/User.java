...
public class User implements Serializable {
	...
	//Stores UUID of all posts created by this user.
	private LinkedList<UUID> userPosts;	
	...
	public User(String username, String password, String email, FXImage profilePic) {
		...
		this.userPosts = new LinkedList<UUID>();
	...
	public LinkedList<UUID> getUserPosts() {
		return userPosts;
	}

	public void setUserPosts(LinkedList<UUID> userPosts) {
